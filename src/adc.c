...
void ADCInit( uint32_t ADC_Clk )
{
  ...
  /* Set pin-mux correct for ADC-0~7 */
  LPC_IOCON->JTAG_TDI_PIO0_11 &= ~0x87;
  LPC_IOCON->JTAG_TDI_PIO0_11 |= 0x02;    /* ADC IN0 */
  LPC_IOCON->JTAG_TMS_PIO1_0  &= ~0x87;
  LPC_IOCON->JTAG_TMS_PIO1_0  |= 0x02;    /* ADC IN1 */
  LPC_IOCON->JTAG_TDO_PIO1_1  &= ~0x87;
  LPC_IOCON->JTAG_TDO_PIO1_1  |= 0x02;    /* ADC IN2 */
  LPC_IOCON->JTAG_nTRST_PIO1_2 &= ~0x87;
  LPC_IOCON->JTAG_nTRST_PIO1_2 |= 0x02;   /* ADC IN3 */
  LPC_IOCON->ARM_SWDIO_PIO1_3 &= ~0x87;
  LPC_IOCON->ARM_SWDIO_PIO1_3 |= 0x02;   /* ADC IN4 */
  LPC_IOCON->PIO1_4 &= ~0x87;
  LPC_IOCON->PIO1_4 |= 0x02;  						 /* ADC IN5 */
  LPC_IOCON->PIO1_10 &= ~0x87;
  LPC_IOCON->PIO1_10 |= 0x02;  						 /* ADC IN6 */
  LPC_IOCON->PIO1_11 &= ~0x87;
